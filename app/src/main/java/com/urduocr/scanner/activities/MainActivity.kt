package com.urduocr.scanner.activities
...
import com.urduocr.scanner.databinding.ActivityMainBinding
            ...
            registerForActivityResult(ActivityResultContracts.StartIntentSenderForResult()) { result ->
                ...
                if (resultCode == RESULT_OK && scanResult != null) {
                    ...
                    if (!pages.isNullOrEmpty()) {
                        ...
                        navController.navigate(R.id.batchExtractFragment)
    ...
    private fun launchDocumentScanner() {
        ...
        documentScanner.getStartScanIntent(this)
            ...
            .addOnFailureListener { e ->
                Toast.makeText(this, "Error launching scanner: ${e.message}", Toast.LENGTH_SHORT)
                    .show()
